...
func Register(s *mcp.Server, sc DocumentScanner, graph GraphStore, search ContentSearcher, semantic SemanticSearch, metrics *ToolMetrics, docMetrics *DocMetrics, cache corecontent.ContentRepository, readOnly bool, auditReader AuditReader) {
